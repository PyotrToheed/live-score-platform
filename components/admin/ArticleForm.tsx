...
export default function ArticleForm({ article, languages }: ArticleFormProps) {
                ...
                <div className="flex items-center space-x-4">
                    <div className="space-y-1">
                        ...
                        <select
                            ...
                            className="block w-full p-2 bg-transparent text-lg font-bold outline-none border-b border-transparent focus:border-blue-600 transition-all"
                        >
